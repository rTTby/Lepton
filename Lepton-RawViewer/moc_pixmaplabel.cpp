...
QT_MOC_LITERAL(4, 26, 11), // "fileDropped"
QT_MOC_LITERAL(5, 38, 8) // "filePath"

    },
    "PixmapLabel\0mouseMoved\0\0p\0fileDropped\0"
    "filePath"
};
...
void PixmapLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PixmapLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseMoved((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 1: _t->fileDropped((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PixmapLabel::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PixmapLabel::mouseMoved)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PixmapLabel::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PixmapLabel::fileDropped)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PixmapLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_PixmapLabel.data,
    qt_meta_data_PixmapLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void PixmapLabel::mouseMoved(QPoint _t1)
{
...
// SIGNAL 1
void PixmapLabel::fileDropped(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
